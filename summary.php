    ...
    <div class="main-card card my-5">
        ...
        <div class="card-body">
            ...
            ?>
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        <strong>ชื่อผู้นิเทศ:</strong> <?php echo htmlspecialchars($post_data['supervisor_name'] ?? 'ไม่มีข้อมูล'); ?>
                    </div>
                    <div class="col-md-6">
                        <strong>เลขบัตรประชาชน:</strong> <?php echo htmlspecialchars($post_data['s_p_id'] ?? 'ไม่มีข้อมูล'); ?>
                    </div>
                    <div class="col-md-6">
                        <strong>สังกัด:</strong> <?php echo htmlspecialchars($post_data['agency'] ?? 'ไม่มีข้อมูล'); ?>
                    </div>
                    <div class="col-md-6">
                        <strong>ตำแหน่ง:</strong> <?php echo htmlspecialchars($post_data['position'] ?? 'ไม่มีข้อมูล'); ?>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <strong>ชื่อผู้รับนิเทศ:</strong> <?php echo htmlspecialchars($post_data['teacher_name'] ?? 'ไม่มีข้อมูล'); ?>
                    </div>
                    <div class="col-md-6">
                        <strong>เลขบัตรประชาชน:</strong> <?php echo htmlspecialchars($post_data['t_p_id'] ?? 'ไม่มีข้อมูล'); ?>
                    </div>
                    <div class="col-md-6">
                        <strong>วิทยฐานะ:</strong> <?php echo htmlspecialchars($post_data['adm_name'] ?? 'ไม่มีข้อมูล'); ?>
                    </div>
                    <div class="col-md-6">
                        <strong>กลุ่มสาระฯ:</strong> <?php echo htmlspecialchars($post_data['learning_group'] ?? 'ไม่มีข้อมูล'); ?>
                    </div>
                </div>
                ...
                <form method="POST" action="form_selector.php" class="mt-4">
                    ...
                    <?php 
                    // วนลูปเพื่อสร้าง hidden fields จากข้อมูลทั้งหมดที่ส่งมาจากหน้าก่อนหน้า
                ...
                <div class="alert alert-warning text-center">
                    ...
                    <a href="index.php" class="btn btn-warning">ไปยังแบบฟอร์ม</a>
                </div>
            <?php endif; ?>
